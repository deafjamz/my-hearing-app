import { sampleStories, enhancedStoryPOC, coffeeShopScenario } from './data.js';
...
const gamification = new GamificationEngine(analytics);
        ...
        const enhancedStoryPOC = {
            ...
            audioFiles: {
                david: "male_audio/story_compass_north.mp3",
                marcus: "male_audio/story_compass_north.mp3", 
                sarah: "female_audio/story_compass_north.mp3",
                emma: "female_audio/story_compass_north.mp3"
            },
        ...
        // GitHub repository configuration for audio files
        // GITHUB_USERNAME and GITHUB_REPO_NAME already declared above
...
function getAudioUrl(filename) {
    ...
    // return `https://cdn.jsdelivr.net/gh/${GITHUB_USERNAME}/${GITHUB_REPO_NAME}@main/${filename}`;
        ...
        async function loadAllData() {
            ...
            try {
                ...
                setTimeout(() => {
                    ...
                    // Initialize caption buttons safely
                    try {
                        setupCaptionButtons();
                    ...
                    // Initialize voice selection safely
                    try {
                        selectVoice('sarah');
                ...
                // Use fallback data to at least make the app functional
                allData = {
                    sentences: [
        ...
        function loadScenarioAudio(interaction) {
            // Voice folder mapping to match repository structure
        ...
        function loadStoryQuestion() {
            ...
            // Setup audio with voice folder mapping
            const voiceFolderMap = {
                'sarah': 'female_audio',
                'emma': 'female_audio',
                'david': 'male_audio', 
