...
# File paths
CSV_PATH = "content/source_csvs/sentences_v2.csv"
PROGRESS_FILE = "sentences_v2_generation_progress.json"
LOG_FILE = "sentences_v2_generation.log"
...
def process_sentence(row, sentence_id, voice):
    ...
    # Upload
    storage_path = f"sentences_v2/{voice_name}/sentence_{sentence_id}.mp3"
