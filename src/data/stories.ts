// Generated from CSVs. Total items: 40
import { ActivityData } from '../types/activity';

export const STORIES: ActivityData[] = [
  {
    "id": "story_1",
    "title": "Barnaby's Big Brave Moment",
    ...
    "audioSrc": "story_timid_teacup.mp3",
    "questions": [],
    "tier": "free"
  },
  {
    "id": "story_2",
    "title": "Miles and the Magic Armchair",
    ...
    "audioSrc": "story_compass_north.mp3",
    "questions": [],
    "tier": "free"
  },
  {
    "id": "story_3",
    "title": "The Great Sock Reunion",
