  ...
  return (
    <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-5 print:border-slate-300">
      ...
      <p className="text-2xl font-bold text-slate-900 dark:text-white print:text-black">
        {data.avgReplays} <span className="text-sm font-medium text-slate-400">avg replays / trial</span>
      </p>
      <div className="mt-3 space-y-1 text-sm text-slate-500 dark:text-slate-400 print:text-slate-600">
        <p>
          No replay: <span className="font-bold text-slate-700 dark:text-slate-300 print:text-black">{data.zeroReplayAccuracy}%</span> accurate
        </p>
        <p>
          With replays: <span className="font-bold text-slate-700 dark:text-slate-300 print:text-black">{data.multiReplayAccuracy}%</span> accurate
        </p>
      </div>
    </div>
  );
